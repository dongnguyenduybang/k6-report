...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 6,
      title: 'should return errors ["messageId should not be empty","messageId invalid ulid","messageId string must contain at least 1 character(s)"] when body {"userId":"{{userId1}}","messageId":"","emoji":"🎉"}',
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const url = 'https://api-dev.ziichat.dev/MessageView/ListDMMessageReactions' + (params ? `?${params}` : '');
