...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":123,"messageId":"{{messageId}}","status":true}',
      payload: {"userId":123,"messageId":"{{messageId}}","status":true},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":"","messageId":"{{messageId}}","status":true}',
      payload: {"userId":"","messageId":"{{messageId}}","status":true},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":null,"messageId":"{{messageId}}","status":true}',
      payload: {"userId":null,"messageId":"{{messageId}}","status":true},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Unauthorized request"] when body {"userId":"invalid_value","messageId":"{{messageId}}","status":true}',
      payload: {"userId":"invalid_value","messageId":"{{messageId}}","status":true},
      expectedErrors: ["Unauthorized request"]
    },

    {
      number: 5,
      title: 'should return errors ["messageId expected string,received number"] when body {"userId":"{{userId}}","messageId":123,"status":true}',
      payload: {"userId":"{{userId}}","messageId":123,"status":true},
      expectedErrors: ["messageId expected string, received number"]
    },

    {
      number: 6,
      title: 'should return errors ["messageId should not be empty","messageId invalid ulid"] when body {"userId":"{{userId}}","messageId":"","status":true}',
      payload: {"userId":"{{userId}}","messageId":"","status":true},
      expectedErrors: ["messageId should not be empty","messageId invalid ulid"]
    },

    {
      number: 7,
      title: 'should return errors ["messageId should not be null"] when body {"userId":"{{userId}}","messageId":null,"status":true}',
      payload: {"userId":"{{userId}}","messageId":null,"status":true},
      expectedErrors: ["messageId should not be null"]
    },

    {
      number: 8,
      title: 'should return errors ["messageId invalid ulid"] when body {"userId":"{{userId}}","messageId":"invalid_ULID","status":true}',
      payload: {"userId":"{{userId}}","messageId":"invalid_ULID","status":true},
      expectedErrors: ["messageId invalid ulid"]
    },

    {
      number: 9,
      title: 'should return errors ["status expected boolean,received string"] when body {"userId":"{{userId}}","messageId":"{{messageId}}","status":"invalid_boolean"}',
      payload: {"userId":"{{userId}}","messageId":"{{messageId}}","status":"invalid_boolean"},
      expectedErrors: ["status expected boolean, received string"]
    },

    {
      number: 10,
      title: 'should return errors ["status should not be null"] when body {"userId":"{{userId}}","messageId":"{{messageId}}","status":null}',
      payload: {"userId":"{{userId}}","messageId":"{{messageId}}","status":null},
      expectedErrors: ["status should not be null"]
    },

    {
      number: 11,
      title: 'should return errors [] when body {"userId":"{{userId}}","messageId":"{{messageId}}","status":true}',
      payload: {"userId":"{{userId}}","messageId":"{{messageId}}","status":true},
      expectedErrors: []
    }
  ];
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.post(
          'https://api-dev.ziichat.dev/Message/PinUnpinDMMessage', 
