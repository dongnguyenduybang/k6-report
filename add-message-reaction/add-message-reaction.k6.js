...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"workspaceId":"","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 5,
      title: 'should return errors ["Invalid channel"] when body {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Invalid channel"]
    },

    {
      number: 6,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 7,
      title: 'should return errors ["Unsupported permission type"] when body {"workspaceId":"0","messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"workspaceId":"0","messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Unsupported permission type"]
    },

    {
      number: 8,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":"","messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"workspaceId":"0","channelId":"","messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 9,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 10,
      title: 'should return errors ["Invalid channel"] when body {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Invalid channel"]
    },

    {
      number: 11,
      title: 'should return errors ["messageId invalid ulid","messageId expected string,received number"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":123,"emoji":"🎉"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":123,"emoji":"🎉"},
      expectedErrors: ["messageId invalid ulid","messageId expected string, received number"]
    },

    {
      number: 12,
      title: 'should return errors ["messageId required","messageId invalid ulid"] when body {"workspaceId":"0","channelId":"{{channelId}}","emoji":"🎉"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","emoji":"🎉"},
      expectedErrors: ["messageId required","messageId invalid ulid"]
    },

    {
      number: 13,
      title: 'should return errors ["messageId should not be empty","messageId invalid ulid"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"","emoji":"🎉"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":"","emoji":"🎉"},
      expectedErrors: ["messageId should not be empty","messageId invalid ulid"]
    },

    {
      number: 14,
      title: 'should return errors ["messageId should not be null"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":null,"emoji":"🎉"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":null,"emoji":"🎉"},
      expectedErrors: ["messageId should not be null"]
    },

    {
      number: 15,
      title: 'should return errors ["messageId invalid ulid"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🎉"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🎉"},
      expectedErrors: ["messageId invalid ulid"]
    },

    {
      number: 16,
      title: 'should return errors ["emoji expected string,received number"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123},
      expectedErrors: ["emoji expected string, received number"]
    },

    {
      number: 17,
      title: 'should return errors ["emoji only accepts 1 emoji"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🎉🎉"}',
    ...
    {
      number: 18,
      title: 'should return errors ["emoji should not be empty","emoji invalid emoji","emoji only accepts 1 emoji"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":""}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":""},
    ...
    {
      number: 19,
      title: 'should return errors ["emoji required"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}"},
      expectedErrors: ["emoji required"]
    },

    {
      number: 20,
      title: 'should return errors ["emoji should not be null"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null},
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.post(
          'https://api-dev.ziichat.dev/Message/AddMessageReaction', 
