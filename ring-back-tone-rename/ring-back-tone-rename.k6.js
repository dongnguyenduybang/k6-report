...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["name expected string,received number"] when body {"name":123,"ringbackToneId":"{{ringbackToneId}}"}',
      payload: {"name":123,"ringbackToneId":"{{ringbackToneId}}"},
      expectedErrors: ["name expected string, received number"]
    },

    {
      number: 2,
      title: 'should return errors ["name should not be empty","name string must contain at least 1 character(s)"] when body {"name":"","ringbackToneId":"{{ringbackToneId}}"}',
      payload: {"name":"","ringbackToneId":"{{ringbackToneId}}"},
      expectedErrors: ["name should not be empty","name string must contain at least 1 character(s)"]
    },

    {
      ...
      payload: {"name":"","ringbackToneId":"{{ringbackToneId}}"},
      expectedErrors: ["name string must contain at most 255 character(s)"]
    },

    {
      number: 4,
      title: 'should return errors ["name required"] when body {"ringbackToneId":"{{ringbackToneId}}"}',
      payload: {"ringbackToneId":"{{ringbackToneId}}"},
      expectedErrors: ["name required"]
    },

    {
      number: 5,
      title: 'should return errors ["ringbackToneId invalid ulid","ringbackToneId expected string,received number"] when body {"name":"channelname1","ringbackToneId":123}',
      payload: {"name":"channelname1","ringbackToneId":123},
      expectedErrors: ["ringbackToneId invalid ulid","ringbackToneId expected string, received number"]
    },

    {
      number: 6,
      title: 'should return errors ["ringbackToneId required","ringbackToneId invalid ulid"] when body {"name":"channelname1"}',
      payload: {"name":"channelname1"},
      expectedErrors: ["ringbackToneId required","ringbackToneId invalid ulid"]
    },

    {
      number: 7,
      title: 'should return errors ["ringbackToneId should not be empty","ringbackToneId invalid ulid"] when body {"name":"channelname1","ringbackToneId":""}',
      payload: {"name":"channelname1","ringbackToneId":""},
      expectedErrors: ["ringbackToneId should not be empty","ringbackToneId invalid ulid"]
    },

    {
      number: 8,
      title: 'should return errors ["ringbackToneId invalid ulid"] when body {"name":"channelname1","ringbackToneId":"invalid_ULID"}',
      payload: {"name":"channelname1","ringbackToneId":"invalid_ULID"},
      expectedErrors: ["ringbackToneId invalid ulid"]
    },

    {
      number: 9,
      title: 'should return errors [] when body {"name":"channelname1","ringbackToneId":"{{ringbackToneId}}"}',
      payload: {"name":"channelname1","ringbackToneId":"{{ringbackToneId}}"},
      expectedErrors: []
    }
  ];
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.put(
          'https://api-dev.ziichat.dev/RingbackTone/RingbackToneRename', 
