...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":123,"channelId":"{{channelId}}","limit":1}',
      payload: {"workspaceId":123,"channelId":"{{channelId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"","channelId":"{{channelId}}","limit":1}',
      payload: {"workspaceId":"","channelId":"{{channelId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":null,"channelId":"{{channelId}}","limit":1}',
      payload: {"workspaceId":null,"channelId":"{{channelId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Invalid channel"] when body {"workspaceId":"invalid_value","channelId":"{{channelId}}","limit":1}',
      payload: {"workspaceId":"invalid_value","channelId":"{{channelId}}","limit":1},
      expectedErrors: ["Invalid channel"]
    },

    {
      number: 5,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":123,"limit":1}',
      payload: {"workspaceId":"0","channelId":123,"limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 6,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":"","limit":1}',
      payload: {"workspaceId":"0","channelId":"","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 7,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":null,"limit":1}',
      payload: {"workspaceId":"0","channelId":null,"limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 8,
      title: 'should return errors ["Invalid channel"] when body {"workspaceId":"0","channelId":"invalid_value","limit":1}',
      payload: {"workspaceId":"0","channelId":"invalid_value","limit":1},
      expectedErrors: ["Invalid channel"]
    },

    {
      number: 9,
      title: 'should return errors ["limit expected number,received nan"] when body {"workspaceId":"0","channelId":"{{channelId}}","limit":"invalid_number"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","limit":"invalid_number"},
    ...
    {
      number: 11,
      title: 'should return errors ["limit should not be empty","limit range from 1 to 500"] when body {"workspaceId":"0","channelId":"{{channelId}}","limit":""}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","limit":""},
      expectedErrors: ["limit should not be empty","limit range from 1 to 500"]
    },

    {
      number: 12,
      title: 'should return errors [] when body {"workspaceId":"0","channelId":"{{channelId}}","limit":1}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","limit":1},
      expectedErrors: []
    }
  ];
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const url = 'https://api-dev.ziichat.dev/MessageView/ListMessages' + (params ? `?${params}` : '');
