...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 23,
      title: 'should return errors [] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","content":"defaultContent"}',
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.put(
          'https://api-dev.ziichat.dev/Message/UpdateMessage', 
