...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":123,"stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"userId":123,"stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":"","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"userId":"","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":null,"stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"userId":null,"stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 5,
      title: 'should return errors ["Unauthorized request"] when body {"userId":"invalid_value","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"userId":"invalid_value","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Unauthorized request"]
    },

    {
      number: 6,
      title: 'should return errors ["stickerId expected string,received number"] when body {"userId":"{{userId}}","stickerId":123,"ref":"ref"}',
      payload: {"userId":"{{userId}}","stickerId":123,"ref":"ref"},
      expectedErrors: ["stickerId expected string, received number"]
    },

    {
      number: 7,
      title: 'should return errors ["stickerId required"] when body {"userId":"{{userId}}","ref":"ref"}',
      payload: {"userId":"{{userId}}","ref":"ref"},
      expectedErrors: ["stickerId required"]
    },

    {
      number: 8,
      title: 'should return errors ["stickerId should not be empty"] when body {"userId":"{{userId}}","stickerId":"","ref":"ref"}',
      payload: {"userId":"{{userId}}","stickerId":"","ref":"ref"},
      expectedErrors: ["stickerId should not be empty"]
    },

    {
      number: 9,
      title: 'should return errors ["stickerId should not be null"] when body {"userId":"{{userId}}","stickerId":null,"ref":"ref"}',
      payload: {"userId":"{{userId}}","stickerId":null,"ref":"ref"},
      expectedErrors: ["stickerId should not be null"]
    },

    {
      number: 10,
      title: 'should return errors ["Message: This sticker has not been exists."] when body {"userId":"{{userId}}","stickerId":"invalid_value","ref":"ref"}',
      payload: {"userId":"{{userId}}","stickerId":"invalid_value","ref":"ref"},
      expectedErrors: ["Message: This sticker has not been exists."]
    },

    {
      number: 11,
      title: 'should return errors ["ref expected string,received number"] when body {"userId":"{{userId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":123}',
      payload: {"userId":"{{userId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":123},
      expectedErrors: ["ref expected string, received number"]
    },

    {
      number: 12,
      title: 'should return errors ["ref string must contain at least 1 character(s)"] when body {"userId":"{{userId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":""}',
      payload: {"userId":"{{userId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":""},
      expectedErrors: ["ref string must contain at least 1 character(s)"]
    },

    {
      number: 13,
      title: 'should return errors ["ref required"] when body {"userId":"{{userId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0"}',
      payload: {"userId":"{{userId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0"},
      expectedErrors: ["ref required"]
    },

    {
      number: 14,
      title: 'should return errors ["ref should not be null"] when body {"userId":"{{userId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":null}',
      payload: {"userId":"{{userId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":null},
      expectedErrors: ["ref should not be null"]
    },

    {
      number: 15,
      title: 'should return errors [] when body {"userId":"{{userId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"userId":"{{userId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: []
    }
  ];
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.post(
          'https://api-dev.ziichat.dev/Message/SendDMMessageSticker', 
