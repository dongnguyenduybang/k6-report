...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["username expected string,received number"] when body {"username":123}',
      payload: {"username":123},
      expectedErrors: ["username expected string, received number"]
    },

    {
      number: 2,
      title: 'should return errors ["username required"] when body {}',
      payload: {},
    ...
    {
      number: 3,
      title: 'should return errors ["username should not be empty"] when body {"username":""}',
      payload: {"username":""},
      expectedErrors: ["username should not be empty"]
    },

    {
      number: 4,
      title: 'should return errors ["username should not be null"] when body {"username":null}',
      payload: {"username":null},
      expectedErrors: ["username should not be null"]
    },

    {
      number: 5,
      title: 'should return errors [] when body {"username":"invalid_value"}',
      payload: {"username":"invalid_value"},
      expectedErrors: []
    },

    {
      number: 6,
      title: 'should return errors [] when body {"username":"{{username}}"}',
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const url = 'https://api-dev.ziichat.dev/UserView/GetUserByUsername' + (params ? `?${params}` : '');
