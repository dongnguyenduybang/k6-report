...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}","limit":1}',
      payload: {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"","channelId":"{{channelId}}","messageId":"{{messageId}}","limit":1}',
      payload: {"workspaceId":"","channelId":"{{channelId}}","messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}","limit":1}',
      payload: {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Invalid channel"] when body {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}","limit":1}',
      payload: {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Invalid channel"]
    },

    {
      number: 5,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}","limit":1}',
      payload: {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 6,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":"","messageId":"{{messageId}}","limit":1}',
      payload: {"workspaceId":"0","channelId":"","messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 7,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}","limit":1}',
      payload: {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 8,
      title: 'should return errors ["Invalid channel"] when body {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}","limit":1}',
      payload: {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Invalid channel"]
    },

    {
      number: 9,
      title: 'should return errors ["messageId invalid ulid","messageId expected string,received number"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":123,"limit":1}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":123,"limit":1},
      expectedErrors: ["messageId invalid ulid","messageId expected string, received number"]
    },

    {
      number: 10,
      title: 'should return errors ["messageId should not be empty","messageId invalid ulid"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"","limit":1}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":"","limit":1},
      expectedErrors: ["messageId should not be empty","messageId invalid ulid"]
    },

    {
      number: 11,
      title: 'should return errors ["messageId should not be null"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":null,"limit":1}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":null,"limit":1},
      expectedErrors: ["messageId should not be null"]
    },

    {
      number: 12,
      title: 'should return errors ["messageId invalid ulid"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID","limit":1}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID","limit":1},
      expectedErrors: ["messageId invalid ulid"]
    },

    {
      number: 13,
      title: 'should return errors ["limit expected number,received nan"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","limit":"invalid_number"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","limit":"invalid_number"},
      expectedErrors: ["limit expected number, received nan"]
    },

    {
      number: 14,
      title: 'should return errors [] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}"}',
    ...
    {
      number: 15,
      title: 'should return errors ["limit should not be empty","limit range from 1 to 500"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","limit":""}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","limit":""},
      expectedErrors: ["limit should not be empty","limit range from 1 to 500"]
    },

    {
      number: 16,
      title: 'should return errors [] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","limit":1}',
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const url = 'https://api-dev.ziichat.dev/MessageView/JumpToMessage' + (params ? `?${params}` : '');
