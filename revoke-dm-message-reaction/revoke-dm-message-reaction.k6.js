...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":123,"messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"userId":123,"messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":"","messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"userId":"","messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":null,"messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"userId":null,"messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 5,
      title: 'should return errors ["Unauthorized request"] when body {"userId":"invalid_value","messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"userId":"invalid_value","messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: ["Unauthorized request"]
    },

    {
      number: 6,
      title: 'should return errors ["messageId invalid ulid","messageId expected string,received number"] when body {"userId":"{{userId1}}","messageId":123,"emoji":"🎉"}',
      payload: {"userId":"{{userId1}}","messageId":123,"emoji":"🎉"},
      expectedErrors: ["messageId invalid ulid","messageId expected string, received number"]
    },

    {
      number: 7,
      title: 'should return errors ["messageId required","messageId invalid ulid"] when body {"userId":"{{userId1}}","emoji":"🎉"}',
      payload: {"userId":"{{userId1}}","emoji":"🎉"},
      expectedErrors: ["messageId required","messageId invalid ulid"]
    },

    {
      number: 8,
      title: 'should return errors ["messageId should not be empty","messageId invalid ulid"] when body {"userId":"{{userId1}}","messageId":"","emoji":"🎉"}',
      payload: {"userId":"{{userId1}}","messageId":"","emoji":"🎉"},
      expectedErrors: ["messageId should not be empty","messageId invalid ulid"]
    },

    {
      number: 9,
      title: 'should return errors ["messageId should not be null"] when body {"userId":"{{userId1}}","messageId":null,"emoji":"🎉"}',
      payload: {"userId":"{{userId1}}","messageId":null,"emoji":"🎉"},
      expectedErrors: ["messageId should not be null"]
    },

    {
      number: 10,
      title: 'should return errors ["messageId invalid ulid"] when body {"userId":"{{userId1}}","messageId":"invalid_ULID","emoji":"🎉"}',
      payload: {"userId":"{{userId1}}","messageId":"invalid_ULID","emoji":"🎉"},
      expectedErrors: ["messageId invalid ulid"]
    },

    {
      number: 11,
      title: 'should return errors ["emoji expected string,received number"] when body {"userId":"{{userId1}}","messageId":"{{messageId}}","emoji":123}',
      payload: {"userId":"{{userId1}}","messageId":"{{messageId}}","emoji":123},
      expectedErrors: ["emoji expected string, received number"]
    },

    {
      number: 12,
      title: 'should return errors ["emoji only accepts 1 emoji"] when body {"userId":"{{userId1}}","messageId":"{{messageId}}","emoji":"🎉🎉"}',
      payload: {"userId":"{{userId1}}","messageId":"{{messageId}}","emoji":"🎉🎉"},
      expectedErrors: ["emoji only accepts 1 emoji"]
    },

    {
      number: 13,
      title: 'should return errors ["emoji should not be empty","emoji invalid emoji","emoji only accepts 1 emoji"] when body {"userId":"{{userId1}}","messageId":"{{messageId}}","emoji":""}',
      payload: {"userId":"{{userId1}}","messageId":"{{messageId}}","emoji":""},
    ...
    {
      number: 14,
      title: 'should return errors ["emoji required"] when body {"userId":"{{userId1}}","messageId":"{{messageId}}"}',
      payload: {"userId":"{{userId1}}","messageId":"{{messageId}}"},
      expectedErrors: ["emoji required"]
    },

    {
      number: 15,
      title: 'should return errors ["emoji should not be null"] when body {"userId":"{{userId1}}","messageId":"{{messageId}}","emoji":null}',
      payload: {"userId":"{{userId1}}","messageId":"{{messageId}}","emoji":null},
      expectedErrors: ["emoji should not be null"]
    },

    {
      number: 16,
      title: 'should return errors [] when body {"userId":"{{userId1}}","messageId":"{{messageId}}","emoji":"🎉"}',
      payload: {"userId":"{{userId1}}","messageId":"{{messageId}}","emoji":"🎉"},
      expectedErrors: []
    }
  ];
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.put(
          'https://api-dev.ziichat.dev/Message/RevokeDMMessageReaction', 
