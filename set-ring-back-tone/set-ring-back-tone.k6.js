...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["ringbackToneId invalid ulid","ringbackToneId expected string,received number"] when body {"ringbackToneId":123}',
      payload: {"ringbackToneId":123},
      expectedErrors: ["ringbackToneId invalid ulid","ringbackToneId expected string, received number"]
    },

    {
      number: 2,
      title: 'should return errors ["ringbackToneId required","ringbackToneId invalid ulid"] when body {}',
      payload: {},
    ...
    {
      number: 3,
      title: 'should return errors ["ringbackToneId should not be empty","ringbackToneId invalid ulid"] when body {"ringbackToneId":""}',
      payload: {"ringbackToneId":""},
      expectedErrors: ["ringbackToneId should not be empty","ringbackToneId invalid ulid"]
    },

    {
      number: 4,
      title: 'should return errors ["ringbackToneId invalid ulid"] when body {"ringbackToneId":"invalid_ULID"}',
      payload: {"ringbackToneId":"invalid_ULID"},
      expectedErrors: ["ringbackToneId invalid ulid"]
    },

    {
      number: 5,
      title: 'should return errors [] when body {"ringbackToneId":"{{ringbackToneId}}"}',
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.put(
          'https://api-dev.ziichat.dev/RingbackTone/SetRingbackTone', 
