...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":123,"ref":"ref"}',
      payload: {"userId":123,"ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"ref":"ref"}',
      payload: {"ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },
    ...
    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":"","ref":"ref"}',
      payload: {"userId":"","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":null,"ref":"ref"}',
      payload: {"userId":null,"ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 5,
      title: 'should return errors ["Unauthorized request"] when body {"userId":"invalid_value","ref":"ref"}',
      payload: {"userId":"invalid_value","ref":"ref"},
      expectedErrors: ["Unauthorized request"]
    },

    {
      number: 6,
      title: 'should return errors ["ref expected string,received number"] when body {"userId":"{{userId}}","ref":123}',
      payload: {"userId":"{{userId}}","ref":123},
      expectedErrors: ["ref expected string, received number"]
    },

    {
      number: 7,
      title: 'should return errors ["ref should not be empty","ref string must contain at least 1 character(s)"] when body {"userId":"{{userId}}","ref":""}',
      payload: {"userId":"{{userId}}","ref":""},
      expectedErrors: ["ref should not be empty","ref string must contain at least 1 character(s)"]
    },

    {
      number: 8,
      title: 'should return errors ["ref required"] when body {"userId":"{{userId}}"}',
    ...
    {
      number: 9,
      title: 'should return errors ["ref should not be null"] when body {"userId":"{{userId}}","ref":null}',
      payload: {"userId":"{{userId}}","ref":null},
      expectedErrors: ["ref should not be null"]
    },

    {
      number: 10,
      title: 'should return errors [] when body {"userId":"{{userId}}","ref":"ref"}',
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.post(
          'https://api-dev.ziichat.dev/Message/SendPokeMessage', 
