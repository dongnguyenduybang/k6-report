...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":123,"channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"workspaceId":123,"channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"workspaceId":"","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":null,"channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"workspaceId":null,"channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 5,
      title: 'should return errors ["Invalid channel"] when body {"workspaceId":"invalid_value","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"workspaceId":"invalid_value","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Invalid channel"]
    },

    {
      number: 6,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":123,"stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"workspaceId":"0","channelId":123,"stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 7,
      title: 'should return errors ["Unsupported permission type"] when body {"workspaceId":"0","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"workspaceId":"0","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Unsupported permission type"]
    },

    {
      number: 8,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":"","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"workspaceId":"0","channelId":"","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 9,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":null,"stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"workspaceId":"0","channelId":null,"stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 10,
      title: 'should return errors ["Invalid channel"] when body {"workspaceId":"0","channelId":"invalid_value","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"workspaceId":"0","channelId":"invalid_value","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: ["Invalid channel"]
    },

    {
      number: 11,
      title: 'should return errors ["stickerId expected string,received number"] when body {"workspaceId":"0","channelId":"{{channelId}}","stickerId":123,"ref":"ref"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","stickerId":123,"ref":"ref"},
      expectedErrors: ["stickerId expected string, received number"]
    },

    {
      number: 12,
      title: 'should return errors ["stickerId required"] when body {"workspaceId":"0","channelId":"{{channelId}}","ref":"ref"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","ref":"ref"},
      expectedErrors: ["stickerId required"]
    },

    {
      number: 13,
      title: 'should return errors ["stickerId should not be empty"] when body {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"","ref":"ref"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"","ref":"ref"},
      expectedErrors: ["stickerId should not be empty"]
    },

    {
      number: 14,
      title: 'should return errors ["stickerId should not be null"] when body {"workspaceId":"0","channelId":"{{channelId}}","stickerId":null,"ref":"ref"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","stickerId":null,"ref":"ref"},
      expectedErrors: ["stickerId should not be null"]
    },

    {
      number: 15,
      title: 'should return errors ["Message: This sticker has not been exists."] when body {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"invalid_value","ref":"ref"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"invalid_value","ref":"ref"},
      expectedErrors: ["Message: This sticker has not been exists."]
    },

    {
      number: 16,
      title: 'should return errors ["ref expected string,received number"] when body {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":123}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":123},
      expectedErrors: ["ref expected string, received number"]
    },

    {
      number: 17,
      title: 'should return errors ["ref string must contain at least 1 character(s)"] when body {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":""}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":""},
      expectedErrors: ["ref string must contain at least 1 character(s)"]
    },

    {
      number: 18,
      title: 'should return errors ["ref required"] when body {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0"},
      expectedErrors: ["ref required"]
    },

    {
      number: 19,
      title: 'should return errors ["ref should not be null"] when body {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":null}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":null},
      expectedErrors: ["ref should not be null"]
    },

    {
      number: 20,
      title: 'should return errors [] when body {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","stickerId":"01JPPHQFHA85NG58H2TYTMCXK0","ref":"ref"},
      expectedErrors: []
    }
  ];
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.post(
          'https://api-dev.ziichat.dev/Message/SendMessageSticker', 
