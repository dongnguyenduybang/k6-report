...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}"}',
      payload: {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"channelId":"{{channelId}}","messageId":"{{messageId}}"}',
      payload: {"channelId":"{{channelId}}","messageId":"{{messageId}}"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"","channelId":"{{channelId}}","messageId":"{{messageId}}"}',
      payload: {"workspaceId":"","channelId":"{{channelId}}","messageId":"{{messageId}}"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}"}',
      payload: {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 5,
      title: 'should return errors ["Invalid channel"] when body {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}"}',
      payload: {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}"},
      expectedErrors: ["Invalid channel"]
    },

    {
      number: 6,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}"}',
      payload: {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 7,
      title: 'should return errors ["Unsupported permission type"] when body {"workspaceId":"0","messageId":"{{messageId}}"}',
      payload: {"workspaceId":"0","messageId":"{{messageId}}"},
      expectedErrors: ["Unsupported permission type"]
    },

    {
      number: 8,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":"","messageId":"{{messageId}}"}',
      payload: {"workspaceId":"0","channelId":"","messageId":"{{messageId}}"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 9,
      title: 'should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}"}',
      payload: {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 10,
      title: 'should return errors ["Invalid channel"] when body {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}"}',
      payload: {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}"},
      expectedErrors: ["Invalid channel"]
    },

    {
      number: 11,
      title: 'should return errors ["messageId invalid ulid","messageId expected string,received number"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":123}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":123},
      expectedErrors: ["messageId invalid ulid","messageId expected string, received number"]
    },

    {
      number: 12,
      title: 'should return errors ["messageId required","messageId invalid ulid"] when body {"workspaceId":"0","channelId":"{{channelId}}"}',
    ...
    {
      number: 13,
      title: 'should return errors ["messageId should not be empty","messageId invalid ulid"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":""}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":""},
      expectedErrors: ["messageId should not be empty","messageId invalid ulid"]
    },

    {
      number: 14,
      title: 'should return errors ["messageId should not be null"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":null}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":null},
      expectedErrors: ["messageId should not be null"]
    },

    {
      number: 15,
      title: 'should return errors ["messageId invalid ulid"] when body {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID"}',
      payload: {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID"},
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.post(
          'https://api-dev.ziichat.dev/Message/MarkAsRead', 
