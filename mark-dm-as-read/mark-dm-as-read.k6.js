...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":123,"messageId":"{{messageId}}"}',
      payload: {"userId":123,"messageId":"{{messageId}}"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"messageId":"{{messageId}}"}',
    ...
    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":"","messageId":"{{messageId}}"}',
      payload: {"userId":"","messageId":"{{messageId}}"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":null,"messageId":"{{messageId}}"}',
      payload: {"userId":null,"messageId":"{{messageId}}"},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 5,
      title: 'should return errors ["Unauthorized request"] when body {"userId":"invalid_value","messageId":"{{messageId}}"}',
      payload: {"userId":"invalid_value","messageId":"{{messageId}}"},
      expectedErrors: ["Unauthorized request"]
    },

    {
      number: 6,
      title: 'should return errors ["messageId invalid ulid","messageId expected string,received number"] when body {"userId":"{{userId1}}","messageId":123}',
      payload: {"userId":"{{userId1}}","messageId":123},
      expectedErrors: ["messageId invalid ulid","messageId expected string, received number"]
    },

    {
      number: 7,
      title: 'should return errors ["messageId required","messageId invalid ulid"] when body {"userId":"{{userId1}}"}',
    ...
    {
      number: 8,
      title: 'should return errors ["messageId should not be empty","messageId invalid ulid"] when body {"userId":"{{userId1}}","messageId":""}',
      payload: {"userId":"{{userId1}}","messageId":""},
      expectedErrors: ["messageId should not be empty","messageId invalid ulid"]
    },

    {
      number: 9,
      title: 'should return errors ["messageId should not be null"] when body {"userId":"{{userId1}}","messageId":null}',
      payload: {"userId":"{{userId1}}","messageId":null},
      expectedErrors: ["messageId should not be null"]
    },

    {
      number: 10,
      title: 'should return errors ["messageId invalid ulid"] when body {"userId":"{{userId1}}","messageId":"invalid_ULID"}',
      payload: {"userId":"{{userId1}}","messageId":"invalid_ULID"},
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.post(
          'https://api-dev.ziichat.dev/Message/MarkDMAsRead', 
