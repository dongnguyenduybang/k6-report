...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["name expected string,received number"] when body {"name":123,"ringbackTonePath":"https://fs.ugc.ziicdn.net/01JEZJ0GPMSHH2RVX9QTSJJNRX/heic_300kB.heic"}',
      payload: {"name":123,"ringbackTonePath":"https://fs.ugc.ziicdn.net/01JEZJ0GPMSHH2RVX9QTSJJNRX/heic_300kB.heic"},
      expectedErrors: ["name expected string, received number"]
    },

    {
      number: 2,
      title: 'should return errors ["name string must contain at least 1 character(s)"] when body {"name":"","ringbackTonePath":"https://fs.ugc.ziicdn.net/01JEZJ0GPMSHH2RVX9QTSJJNRX/heic_300kB.heic"}',
      payload: {"name":"","ringbackTonePath":"https://fs.ugc.ziicdn.net/01JEZJ0GPMSHH2RVX9QTSJJNRX/heic_300kB.heic"},
      expectedErrors: ["name string must contain at least 1 character(s)"]
    },

    {
      number: 3,
      title: 'should return errors ["name string must contain at most 255 character(s)"] when body {"name":"","ringbackTonePath":"https://fs.ugc.ziicdn.net/01JEZJ0GPMSHH2RVX9QTSJJNRX/heic_300kB.heic"}',
      ...
      expectedErrors: ["name string must contain at most 255 character(s)"]
    },

    {
      number: 4,
      title: 'should return errors ["name required"] when body {"ringbackTonePath":"https://fs.ugc.ziicdn.net/01JEZJ0GPMSHH2RVX9QTSJJNRX/heic_300kB.heic"}',
      payload: {"ringbackTonePath":"https://fs.ugc.ziicdn.net/01JEZJ0GPMSHH2RVX9QTSJJNRX/heic_300kB.heic"},
      expectedErrors: ["name required"]
    },

    {
      number: 5,
      title: 'should return errors ["name should not be null"] when body {"name":null,"ringbackTonePath":"https://fs.ugc.ziicdn.net/01JEZJ0GPMSHH2RVX9QTSJJNRX/heic_300kB.heic"}',
      payload: {"name":null,"ringbackTonePath":"https://fs.ugc.ziicdn.net/01JEZJ0GPMSHH2RVX9QTSJJNRX/heic_300kB.heic"},
      expectedErrors: ["name should not be null"]
    },

    {
      number: 6,
      title: 'should return errors ["ringbackTonePath expected string,received number"] when body {"name":"channelname1","ringbackTonePath":123}',
      payload: {"name":"channelname1","ringbackTonePath":123},
      expectedErrors: ["ringbackTonePath expected string, received number"]
    },

    {
      number: 7,
      title: 'should return errors ["ringbackTonePath invalid url","ringbackTonePath string must contain at least 1 character(s)"] when body {"name":"channelname1","ringbackTonePath":""}',
      payload: {"name":"channelname1","ringbackTonePath":""},
      expectedErrors: ["ringbackTonePath invalid url","ringbackTonePath string must contain at least 1 character(s)"]
    },

    {
      number: 8,
      title: 'should return errors ["ringbackTonePath required","ringbackTonePath invalid url"] when body {"name":"channelname1"}',
      payload: {"name":"channelname1"},
      expectedErrors: ["ringbackTonePath required","ringbackTonePath invalid url"]
    },

    {
      number: 9,
      title: 'should return errors ["ringbackTonePath should not be null"] when body {"name":"channelname1","ringbackTonePath":null}',
      payload: {"name":"channelname1","ringbackTonePath":null},
      expectedErrors: ["ringbackTonePath should not be null"]
    },

    {
      number: 10,
      title: 'should return errors [] when body {"name":"channelname1","ringbackTonePath":"https://fs.ugc.ziicdn.net/01JEZJ0GPMSHH2RVX9QTSJJNRX/heic_300kB.heic"}',
      payload: {"name":"channelname1","ringbackTonePath":"https://fs.ugc.ziicdn.net/01JEZJ0GPMSHH2RVX9QTSJJNRX/heic_300kB.heic"},
      expectedErrors: []
    }
  ];
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.post(
          'https://api-dev.ziichat.dev/RingbackTone/RingbackToneCreate', 
