...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":123,"originalMessageIds":["{{messageId}}"]}',
      payload: {"userId":123,"originalMessageIds":["{{messageId}}"]},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"originalMessageIds":["{{messageId}}"]}',
      payload: {"originalMessageIds":["{{messageId}}"]},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":"","originalMessageIds":["{{messageId}}"]}',
      payload: {"userId":"","originalMessageIds":["{{messageId}}"]},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":null,"originalMessageIds":["{{messageId}}"]}',
      payload: {"userId":null,"originalMessageIds":["{{messageId}}"]},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 5,
      title: 'should return errors ["Unauthorized request"] when body {"userId":"invalid_value","originalMessageIds":["{{messageId}}"]}',
      payload: {"userId":"invalid_value","originalMessageIds":["{{messageId}}"]},
      expectedErrors: ["Unauthorized request"]
    },

    {
      number: 6,
      title: 'should return errors ["originalMessageIds expected array,received string"] when body {"userId":"{{userId1}}","originalMessageIds":"not_an_array"}',
      payload: {"userId":"{{userId1}}","originalMessageIds":"not_an_array"},
      expectedErrors: ["originalMessageIds expected array, received string"]
    },

    {
      number: 7,
      title: 'should return errors ["originalMessageIds array must contain at least 1 element(s)"] when body {"userId":"{{userId1}}","originalMessageIds":[]}',
      payload: {"userId":"{{userId1}}","originalMessageIds":[]},
      expectedErrors: ["originalMessageIds array must contain at least 1 element(s)"]
    },

    {
      number: 8,
      title: 'should return errors ["originalMessageIds has element 0 expected string,received number","originalMessageIds has element 0 invalid ulid"] when body {"userId":"{{userId1}}","originalMessageIds":[123]}',
      payload: {"userId":"{{userId1}}","originalMessageIds":[123]},
      expectedErrors: ["originalMessageIds has element 0 expected string, received number","originalMessageIds has element 0 invalid ulid"]
    },

    {
      number: 9,
      title: 'should return errors ["originalMessageIds has element 0 invalid ulid"] when body {"userId":"{{userId1}}","originalMessageIds":["valid_string"]}',
      payload: {"userId":"{{userId1}}","originalMessageIds":["valid_string"]},
      expectedErrors: ["originalMessageIds has element 0 invalid ulid"]
    },

    {
      number: 10,
      title: 'should return errors ["Code: 404. Message: Data not found. Details: Data not found."] when body {"userId":"{{userId1}}","originalMessageIds":["01K0GQ0ZE527GA0HAGSMKW1TSG"]}',
      payload: {"userId":"{{userId1}}","originalMessageIds":["01K0GQ0ZE527GA0HAGSMKW1TSG"]},
      expectedErrors: ["Code: 404. Message: Data not found. Details: Data not found."]
    },

    {
      number: 11,
      title: 'should return errors ["originalMessageIds has element 0 invalid ulid","originalMessageIds array must contain unique items","originalMessageIds has element 1 invalid ulid"] when body {"userId":"{{userId1}}","originalMessageIds":["uniqueItem","uniqueItem"]}',
      payload: {"userId":"{{userId1}}","originalMessageIds":["uniqueItem","uniqueItem"]},
      expectedErrors: ["originalMessageIds has element 0 invalid ulid","originalMessageIds array must contain unique items","originalMessageIds has element 1 invalid ulid"]
    },

    {
      number: 12,
      title: 'should return errors ["originalMessageIds has element 0 expected string,received object","originalMessageIds has element 0 invalid ulid"] when body {"userId":"{{userId1}}","originalMessageIds":[null]}',
      payload: {"userId":"{{userId1}}","originalMessageIds":[null]},
      expectedErrors: ["originalMessageIds has element 0 expected string, received object","originalMessageIds has element 0 invalid ulid"]
    },

    {
      number: 13,
      title: 'should return errors ["originalMessageIds has element 0 invalid ulid","originalMessageIds has element 0 string must contain at least 1 character(s)"] when body {"userId":"{{userId1}}","originalMessageIds":[""]}',
      payload: {"userId":"{{userId1}}","originalMessageIds":[""]},
      expectedErrors: ["originalMessageIds has element 0 invalid ulid","originalMessageIds has element 0 string must contain at least 1 character(s)"]
    },

    {
      number: 14,
      title: 'should return errors ["originalMessageIds required","originalMessageIds expected array,received undefined"] when body {"userId":"{{userId1}}"}',
      payload: {"userId":"{{userId1}}"},
      expectedErrors: ["originalMessageIds required","originalMessageIds expected array, received undefined"]
    },

    {
      number: 15,
      title: 'should return errors [] when body {"userId":"{{userId1}}","originalMessageIds":["{{messageId}}"]}',
      payload: {"userId":"{{userId1}}","originalMessageIds":["{{messageId}}"]},
      expectedErrors: []
    }
  ];
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const response = http.post(
          'https://api-dev.ziichat.dev/Message/ForwardMessagesToDMChannel', 
