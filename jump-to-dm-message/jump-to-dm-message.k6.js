...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":123,"messageId":"{{messageId}}","limit":1}',
      payload: {"userId":123,"messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":"","messageId":"{{messageId}}","limit":1}',
      payload: {"userId":"","messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":null,"messageId":"{{messageId}}","limit":1}',
      payload: {"userId":null,"messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Unauthorized request"] when body {"userId":"invalid_value","messageId":"{{messageId}}","limit":1}',
      payload: {"userId":"invalid_value","messageId":"{{messageId}}","limit":1},
      expectedErrors: ["Unauthorized request"]
    },

    {
      number: 5,
      title: 'should return errors ["messageId invalid ulid","messageId expected string,received number"] when body {"userId":"{{userId1}}","messageId":123,"limit":1}',
      payload: {"userId":"{{userId1}}","messageId":123,"limit":1},
      expectedErrors: ["messageId invalid ulid","messageId expected string, received number"]
    },

    {
      number: 6,
      title: 'should return errors ["messageId should not be empty","messageId invalid ulid"] when body {"userId":"{{userId1}}","messageId":"","limit":1}',
      payload: {"userId":"{{userId1}}","messageId":"","limit":1},
      expectedErrors: ["messageId should not be empty","messageId invalid ulid"]
    },

    {
      number: 7,
      title: 'should return errors ["messageId should not be null"] when body {"userId":"{{userId1}}","messageId":null,"limit":1}',
      payload: {"userId":"{{userId1}}","messageId":null,"limit":1},
      expectedErrors: ["messageId should not be null"]
    },

    {
      number: 8,
      title: 'should return errors ["messageId invalid ulid"] when body {"userId":"{{userId1}}","messageId":"invalid_ULID","limit":1}',
      payload: {"userId":"{{userId1}}","messageId":"invalid_ULID","limit":1},
      expectedErrors: ["messageId invalid ulid"]
    },

    {
      number: 9,
      title: 'should return errors ["limit expected number,received nan"] when body {"userId":"{{userId1}}","messageId":"{{messageId}}","limit":"invalid_number"}',
      payload: {"userId":"{{userId1}}","messageId":"{{messageId}}","limit":"invalid_number"},
      expectedErrors: ["limit expected number, received nan"]
    },

    {
      number: 10,
      title: 'should return errors [] when body {"userId":"{{userId1}}","messageId":"{{messageId}}"}',
    ...
    {
      number: 11,
      title: 'should return errors ["limit should not be empty","limit range from 1 to 500"] when body {"userId":"{{userId1}}","messageId":"{{messageId}}","limit":""}',
      payload: {"userId":"{{userId1}}","messageId":"{{messageId}}","limit":""},
      expectedErrors: ["limit should not be empty","limit range from 1 to 500"]
    },

    {
      number: 12,
      title: 'should return errors [] when body {"userId":"{{userId1}}","messageId":"{{messageId}}","limit":1}',
      payload: {"userId":"{{userId1}}","messageId":"{{messageId}}","limit":1},
      expectedErrors: []
    }
  ];
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const url = 'https://api-dev.ziichat.dev/MessageView/JumpToDMMessage' + (params ? `?${params}` : '');
