...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["limit expected number,received nan"] when body {"limit":"invalid_number"}',
      payload: {"limit":"invalid_number"},
      expectedErrors: ["limit expected number, received nan"]
    },

    {
      number: 2,
      title: 'should return errors [] when body {}',
      payload: {},
      expectedErrors: []
    },
    ...
    {
      number: 3,
      title: 'should return errors ["limit should not be empty","limit range from 1 to 500"] when body {"limit":""}',
      payload: {"limit":""},
    ...
    {
      number: 4,
      title: 'should return errors [] when body {"limit":1}',
      payload: {"limit":1},
      expectedErrors: []
    }
  ];
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const url = 'https://api-dev.ziichat.dev/ChannelView/ListInComingMessageRequests' + (params ? `?${params}` : '');
