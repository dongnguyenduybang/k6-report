...
export default function (data) {
  ...
  const testCases = [
    ...
    {
      number: 1,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":123,"limit":1}',
      payload: {"userId":123,"limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 2,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":"","limit":1}',
      payload: {"userId":"","limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 3,
      title: 'should return errors ["Could not resolve permission type"] when body {"userId":null,"limit":1}',
      payload: {"userId":null,"limit":1},
      expectedErrors: ["Could not resolve permission type"]
    },

    {
      number: 4,
      title: 'should return errors ["Unauthorized request"] when body {"userId":"invalid_value","limit":1}',
      payload: {"userId":"invalid_value","limit":1},
      expectedErrors: ["Unauthorized request"]
    },

    {
      number: 5,
      title: 'should return errors ["limit expected number,received nan"] when body {"userId":"{{userId1}}","limit":"invalid_number"}',
      payload: {"userId":"{{userId1}}","limit":"invalid_number"},
      expectedErrors: ["limit expected number, received nan"]
    },

    {
      number: 6,
      title: 'should return errors [] when body {"userId":"{{userId1}}"}',
    ...
    {
      number: 7,
      title: 'should return errors ["limit should not be empty","limit range from 1 to 500"] when body {"userId":"{{userId1}}","limit":""}',
      payload: {"userId":"{{userId1}}","limit":""},
      expectedErrors: ["limit should not be empty","limit range from 1 to 500"]
    },

    {
      number: 8,
      title: 'should return errors [] when body {"userId":"{{userId1}}","limit":1}',
      payload: {"userId":"{{userId1}}","limit":1},
      expectedErrors: []
    }
  ];
  ...
  testCases.forEach(test => {
    group(`Test case #${test.number}: ${test.title}`, () => {
      ...
      const url = 'https://api-dev.ziichat.dev/MessageView/ListDMMessages' + (params ? `?${params}` : '');
